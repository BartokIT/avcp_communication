$(function(){
			...
			var oTour = new Tour({
				steps:[
					...
					{	path:"?action=new_gara" }, //step: 1
                    {	path:"?action=new_gara"	}, //step: 2 
                    {	//step: 3
					...
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 4
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 5
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 6
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 7
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 8
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 9
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 10
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 11
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 12
					{	path : $(".dummy .edit-partecipant").attr("href") }, //step: 13
					{	//step: 14

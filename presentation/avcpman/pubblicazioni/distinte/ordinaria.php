...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Posta ordinaria - Elenco n. <?php echo $p["id"] . " del  " . $p["date"]; ?></title>
...
?>
	<div id="content" class="ordinaria-view">
	    ...
	    <p class="list-header"> Elenco pieghi <strong>Posta ordinaria</strong> consegnati all'ufficio postale di Latina Centro</p>	

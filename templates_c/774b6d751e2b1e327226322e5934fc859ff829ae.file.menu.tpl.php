<?php /* Smarty version Smarty-3.1.18, created on 2014-11-11 15:16:47
...
?><ul id="menu_v">
    ...
    <li>
        <a href="<?php echo smarty_function_urlarea(array('nonce'=>"false",'area'=>"avcpman/pubblicazioni"),$_smarty_tpl);?>
">Pubblicazioni</a>
    </li>
    ...
    <li>
        <a href="<?php echo smarty_function_urlarea(array('nonce'=>"false",'area'=>"avcpman/gare"),$_smarty_tpl);?>
">Gare</a>
    </li>
    <li>
        <a href="<?php echo smarty_function_urlarea(array('nonce'=>"false",'area'=>"avcpman/ditte"),$_smarty_tpl);?>
">Ditte</a>
    </li>
    ...
    <li>
        <a href="<?php echo smarty_function_urlarea(array('nonce'=>"false",'area'=>"avcpman/impostazioni"),$_smarty_tpl);?>
">Impostazioni</a>
    </li>
